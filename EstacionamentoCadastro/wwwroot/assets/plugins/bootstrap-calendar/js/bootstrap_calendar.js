    ...
    $.fn.calendar = function(options) {
        ...
        this.each(function(){
            ...
            if ( typeof args.months != "undefined" )
                ...
                months = ["January", "FebPraçary", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
            ...
            function showCalendar(){
                ...
                //current month & year
                var month = args.month || dateObj.getMonth();
                var year = args.year || dateObj.getFullYear();
